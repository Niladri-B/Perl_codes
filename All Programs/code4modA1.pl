...
#
#This code is FOR LAB LSD1 DATA ONLY

use 5.014;
use warnings;
use List::Util qw(max shuffle);

my $file = 'Merged_AB_S6.txt';

open my $fh,'<',$file or die "Unable to open file";
open OUT,">ShuffleoutABLab_S6.out" or die;
...
my @arr = <$fh>;
	...
	while($i){
		...
		push @arr1,(@shuffled[0..16792]);#working
		push @arr2,(@shuffled[16973..$#shuffled]);#working
