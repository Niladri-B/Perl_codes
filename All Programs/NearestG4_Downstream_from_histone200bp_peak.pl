...
#Assign filenames
my $file1 = '200Peak_End_chrY.out';#'lsdpeakmid.txt'; #case insensitive
my $file2 = '+_chrY_G4_start.out' ;#'pg4mid.txt';
...
#Open Output File
open OUT, ">H3K4me2_nearest_Downg4_chrY.out" or die $!;
...
while (<$fh1>){
        ...
        my $str=sprintf("%-8s %-10d %-5s %-8s",$k, $v,$aft?"No":"Yes",$aft?$aft:""); #$v = number, hence %d used, others have strings as input hence &s is used    ,$aft?$aft:""
