...
#this code prints out the explicit values of set 1 and set 2
...
my @arr = <$fh>;
	...
	while($i){
		...
		push @arr1,(@shuffled[0..1]);#working
		push @arr2,(@shuffled[2..3]);#working
