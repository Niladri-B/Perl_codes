...
open OUT, ">LSD1_+_-_10kb_TSS_chr23.out" or die $!;#Modify to desired output file
...
open my $fh, '<', 'TSS-10kb_chr23_mod.out';#File with start co-ordinates viz the minimum positions
