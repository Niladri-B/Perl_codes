...
my $file = '+_SimpleRepeats_Known_Chrom_Regions.txt';
...
while(<$fh>){
	...
	if($val[5] eq 'chr1'){
		#print "@val \n";
		 say OUT1 join ("\t",$val[5],$val[6],$val[7]);
		
	}elsif($val[5] eq 'chr2'){
		say OUT2 join("\t",$val[5],$val[6],$val[7]);
		
	}elsif($val[5] eq 'chr3'){
		say OUT3 join("\t",$val[5],$val[6],$val[7]);
		
	}elsif($val[5] eq 'chr4'){
		say OUT4 join("\t",$val[5],$val[6],$val[7]);
		
	}elsif($val[5] eq 'chr5'){
		say OUT5 join("\t",$val[5],$val[6],$val[7]);
	
	}elsif($val[5] eq 'chr6'){
		say OUT6 join("\t",$val[5],$val[6],$val[7]);
	
	}elsif($val[5] eq 'chr7'){
		say OUT7 join("\t",$val[5],$val[6],$val[7]);
	
	}elsif($val[5] eq 'chr8'){
		say OUT8 join("\t",$val[5],$val[6],$val[7]);
	
	}elsif($val[5] eq 'chr9'){
		say OUT9 join("\t",$val[5],$val[6],$val[7]);
	
	}elsif($val[5] eq 'chr10'){
		say OUT10 join("\t",$val[5],$val[6],$val[7]);
		
	}elsif($val[5] eq 'chr11'){
		say OUT11 join("\t",$val[5],$val[6],$val[7]);
	
	}elsif($val[5] eq 'chr12'){
		say OUT12 join("\t",$val[5],$val[6],$val[7]);
		
	}elsif($val[5] eq 'chr13'){
		say OUT13 join("\t",$val[5],$val[6],$val[7]);
	
	}elsif($val[5] eq 'chr14'){
		say OUT14 join("\t",$val[5],$val[6],$val[7]);
	
	}elsif($val[5] eq 'chr15'){
		say OUT15 join("\t",$val[5],$val[6],$val[7]);
	
	}elsif($val[5] eq 'chr16'){
		say OUT16 join("\t",$val[5],$val[6],$val[7]);
	
	}elsif($val[5] eq 'chr17'){
		say OUT17 join("\t",$val[5],$val[6],$val[7]);
	
	}elsif($val[5] eq 'chr18'){
		say OUT18 join("\t",$val[5],$val[6],$val[7]);
	
	}elsif($val[5] eq 'chr19'){
		say OUT19 join("\t",$val[5],$val[6],$val[7]);
	
	}elsif($val[5] eq 'chr20'){
		say OUT20 join("\t",$val[5],$val[6],$val[7]);
	
	}elsif($val[5] eq 'chr21'){
		say OUT21 join("\t",$val[5],$val[6],$val[7]);
	
	}elsif($val[5] eq 'chr22'){
		say OUT22 join("\t",$val[5],$val[6],$val[7]);
	
	}elsif($val[5] eq 'chrX'){
		say OUT23 join("\t",$val[5],$val[6],$val[7]);
	
	}else{
		say OUT24 join("\t",$val[5],$val[6],$val[7]);
	}
