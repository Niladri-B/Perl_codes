...
my $file1 = "LSD1_without_Alu_genes.out";
my $file2 = "CoREST_without_Alu_genes.out";
my $file3 = "REST_without_Alu_genes.out";
my $file4 = "h3k4me1_without_Alu_genes.out";
my $file5 = "h3k4me2_without_Alu_genes.out";
...
open OUT, ">RPKM_without_Alu_genes.out" or die $!;
