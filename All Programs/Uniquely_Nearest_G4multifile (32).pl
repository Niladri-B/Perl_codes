...
#Code to select uniquely neaCoREST G4

#Intialize loop
#for(my $i = 1; $i <= 1000; $i++){

		#Assign filename
		my $file = "All_CoREST_TSS_distance.out";
		...
		#Open output file
		#open OUT, ">Uniquely_NeaCoREST_G4_LSD1_$i.out" or die $!;
		 open OUT, ">Uniquely_Nearest_CoREST_TSS.out" or die $!;
