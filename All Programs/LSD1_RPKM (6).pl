...
#Code to extract LSD1 genes given RPKM genes [THIS IS FOR BEDTOOLS INPUT]
  ...
  open OUT, ">RPKM_Common_LSD1_COREST_REST_A_genes_g4_within_100bp.out" or die $!;

  my @file2;
  {
    open my $fh, '<', "Common_LSD1_COREST_REST_A_genes_g4_within_100bp.out";#"COREST_A_100bp_g4_genes.out";#"Common_LSD1_COREST_REST_H3K4me1_H3K4me2_B_genes.out";#Modify to Midpg4chr*.out
    while (<$fh>) {
      chomp;
