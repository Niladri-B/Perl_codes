...
#Code to select uniquely neaLSD1 G4

#Intialize loop
#for(my $i = 1; $i <= 1000; $i++){

		#Assign filename
		my $file = "All_LSD1_TSS_distance.out";
		...
		#Open output file
		#open OUT, ">Uniquely_NeaLSD1_G4_LSD1_$i.out" or die $!;
		 open OUT, ">Uniquely_Nearest_LSD1_TSS.out" or die $!;
