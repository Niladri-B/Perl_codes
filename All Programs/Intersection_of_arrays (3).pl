...
my $file1 = "LSD1_with_CR1_genes.out";
my $file2 = "CoREST_with_CR1_genes.out";
my $file3 = "REST_with_CR1_genes.out";
my $file4 = "h3k4me1_with_CR1_genes.out";
my $file5 = "h3k4me2_with_CR1_genes.out";
...
open OUT, ">RPKM_with_CR1_genes.out" or die $!;
