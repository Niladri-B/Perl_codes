...
#Code to extract REST genes given RPKM genes [THIS IS FOR BEDTOOLS INPUT]


  open OUT, ">REST_with_Alu_RPKM.out" or die $!;#Modify to desired output file

  my @file2;
  {
    open my $fh, '<', "REST_with_Alu_genes.out";#Modify to Midpg4chr*.out
    while (<$fh>) {
      chomp;
