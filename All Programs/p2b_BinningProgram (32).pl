...
use constant SAMPLE_SIZE => 10_000; #End value
use constant CHUNK_SIZE => 25; #Assign value of bin

my $file1 = 'chrX_SB.txt'; #File containing start co-ordinates
my $file2 = 'MidVal_peak_chrX.out'; #Chip_Seq peak read data

open OUT,'>','LSD1chrXBOUT.out' or die;
