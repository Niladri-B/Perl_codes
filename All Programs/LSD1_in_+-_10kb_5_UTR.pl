...
open OUT, ">LSD1_+_-_10kb_5UTRMid_chr23.out" or die $!;#Modify to desired output file
...
open my $fh, '<', '5_UTR_Mid-10kb_chr23_mod.out';#File with start co-ordinates viz the minimum positions
