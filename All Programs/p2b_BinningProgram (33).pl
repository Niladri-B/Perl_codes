...
for(my $i =1; $i <= 23; $i++){
  ...
  my $file1 = "Mod_SB_chr$i.txt"; #File containing start co-ordinates
  my $file2 = "with_signals_LSD1_within_CoREST_&REST_chr$i.out"; #Chip_Seq peak read data

  open OUT,'>',"lsd1_complex_WITHOUTG4_chr$i.out" or die;
