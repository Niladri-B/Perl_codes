...
for(my $i =1; $i <= 23; $i++){
  ...
  my $file1 = "Mod_SA_chr$i.txt"; #File containing start co-ordinates
  my $file2 = "with_signals_lsd1_coordinates=chr$i.out"; #Chip_Seq peak read data

  open OUT,'>',"lsd1_complex_g4_250bp_chr$i.out" or die;
