...
#Assign filename
my $file1 = 'SortedTSS_chr24_mod.out.out ';#'lsdpeakmid.txt'; #case insensitive#WHAT WE ARE COMPARING
my $file2 = 'MidVal_peak_chrY.out' ;#'pg4mid.txt';#AGAINST WHOM WE ARE COMPARING ie THE NEAREST FILE

open my $fh1,'<',$file1 or die $!;
open my $fh2,'<',$file2 or die $!;

open OUT, ">TSS_nearest_LSD1_distance_chrY.out" or die $!;
