...
#Assign filename
my $file = 'Uniquely_Nearest G4_in_LSD1_around_20kb_5UTRs.out.out' ;

#Open file
open my $fh, '<', $file or die $!;

#Open output file
open OUT, ">Output_U.out" or die $!;
...
while(<$fh>){
	...
	if(  $val[3] < 0 &&   $val[3] >= - 50){
		...
		$Ucount3550++;
	}elsif( $val[3] <  -3550 &&  $val[3] >= - 3650){
		$Ucount3600++;
	}elsif( $val[3] <  -3600 &&  $val[3] >= - 3700){
		$Ucount3650++;
	}elsif( $val[3] <  -3650 &&  $val[3] >= - 3750){
		$Ucount3700++;
	}elsif( $val[3] <  -3700 &&  $val[3] >= - 3800){
		$Ucount3750++;
	}elsif( $val[3] <  -3750 &&  $val[3] >= - 3850){
		$Ucount3800++;
	}elsif( $val[3] <  -3800 &&  $val[3] >= - 3900){
		$Ucount3850++;
	}elsif( $val[3] <  -3850 &&  $val[3] >= - 3950){
		$Ucount3900++;
	}elsif( $val[3] <  -3900 &&  $val[3] >= - 4000){
		$Ucount3950++;
	}elsif( $val[3] <  -3950 &&  $val[3] >= - 4050){
		$Ucount4000++;
	}elsif( $val[3] <  -4000 &&  $val[3] >= - 4100){
		$Ucount4050++;
	}elsif( $val[3] <  -4050 &&  $val[3] >= - 4150){
		$Ucount4100++;
